  ...
  const slides = [
    {
      ...
      description:
        "Our innovative AI tool helps you create the perfect dress that matches your style and preferences.",
    ...
    },
    {
      ...
      description:
        "Discover our latest summer dresses designed for comfort and style.",
      buttonText: "Shop Now",
    ...
    },
    {
      id: 3,
      image:
        "https://images.unsplash.com/photo-1515372039744-b8f02a3ae446?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2068&q=80",
      title: "Rent Designer Dresses",
      description:
        "Look stunning for your special occasion without breaking the bank.",
  ...
  const categories = [
    {
      ...
      name: "Ethnic",
      image:
        "https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80",
      slug: "ethnic",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      name: "Party Wear",
      image:
        "https://images.unsplash.com/photo-1566174053879-31528523f8ae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1008&q=80",
      slug: "party-wear",
    },
    {
      id: 4,
      name: "Coat Sets",
      image:
        "https://images.unsplash.com/photo-1548624313-0396c75e4b1a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80",
      slug: "coat-sets",
    },
    {
      id: 5,
